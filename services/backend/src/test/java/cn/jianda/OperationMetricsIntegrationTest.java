...
class OperationMetricsIntegrationTest {
    ...
    void platformAdminReadsRealMetricsAndCreatesDailySnapshot() throws Exception {
        ...
        mvc.perform(get("/api/operation-metrics")
                ...
                .andExpect(jsonPath("$.data.weeklyPublishedCount").isNumber())
                .andExpect(jsonPath("$.data.weeklyViewCount").isNumber())
                .andExpect(jsonPath("$.data.weeklyListenCount").isNumber())
                .andExpect(jsonPath("$.data.weeklyFavoriteCount").isNumber())
                .andExpect(jsonPath("$.data.weeklyReminderCount").isNumber())
                .andExpect(jsonPath("$.data.popularContent").isArray())
